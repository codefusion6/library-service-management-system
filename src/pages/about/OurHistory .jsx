    ...
    <div className="bg-gray-100 min-h-screen">
      <div className="container mx-auto p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded shadow-md mb-8">
            <h2 className="text-xl font-semibold mb-4">
              <span className="bg-gradient-to-r from-[#4b79a7] to-[#4ebcde] text-transparent text-white px-4 py-2 rounded-sm">Inception</span>
            </h2>
          ...
          <div className="bg-white p-6 rounded shadow-md mb-8">
            <h2 className="text-xl font-semibold mb-4">
              <span className="bg-gradient-to-r from-[#4b79a7] to-[#4ebcde] text-transparent text-white px-4 py-2 rounded-sm">Early Growth</span>
            </h2>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-6 rounded shadow-md mb-8">
            <h2 className="text-xl font-semibold mb-4">
              <span className="bg-gradient-to-r from-[#4b79a7] to-[#4ebcde] text-transparent text-white px-4 py-2 rounded-sm">Milestones</span>
            </h2>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-6 rounded shadow-md mb-8">
            <h2 className="text-xl font-semibold mb-4">
              <span className="bg-gradient-to-r from-[#4b79a7] to-[#4ebcde] text-transparent text-white px-4 py-2 rounded-sm">Community Building</span>
            </h2>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-6 rounded shadow-md mb-8">
            <h2 className="text-xl font-semibold mb-4">
              <span className="bg-gradient-to-r from-[#4b79a7] to-[#4ebcde] text-transparent text-white px-4 py-2 rounded-sm">Technological Advancements</span>
            </h2>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-6 rounded shadow-md mb-8">
            <h2 className="text-xl font-semibold mb-4">
              <span className="bg-gradient-to-r from-[#4b79a7] to-[#4ebcde] text-transparent text-white px-4 py-2 rounded-sm">Vision Realized</span>
            </h2>
            <p className="text-gray-700">
        ...
        <div className="bg-white p-8 rounded shadow-md">
          <h2 className="text-xl font-semibold mb-4">
              <span className="bg-gradient-to-r from-[#4b79a7] to-[#4ebcde] text-transparent text-white px-4 py-2 rounded-sm">Looking Ahead</span>
            </h2>
          <p className="text-gray-700">
