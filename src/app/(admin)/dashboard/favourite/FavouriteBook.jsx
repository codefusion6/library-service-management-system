...
import { deleteFavourite } from '@/libs/actions/favourite.action'
        ...
        <div className='flex gap-4 p-2 border my-3'>
            ...
            <div className='flex-1 p-4 flex flex-col justify-between'>
                ...
                <div className='flex gap-5 mt-10'>
                    ...
                    <button onClick={() => handleRemove(book?._id)} className='py-1 px-3 md:px-5 bg-primary text-white roumded-md'>Remove</button>
                </div>
            </div>
        </div>
    )
