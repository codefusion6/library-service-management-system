...
const BookDetails = () => {
  return (
    <div className="container mx-auto">
      ...
      <div className="w-full flex flex-col md:flex-row max-w-md mx-auto bg-white shadow-lg rounded-lg border-2 border-transparent hover:border-green-500 hover:border-2">
